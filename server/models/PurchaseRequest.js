...
const purchaseRequestSchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    enum: ['pending_approval', 'pending_assignment', 'approved', 'rejected', 'cancelled', 'in_transit', 'received_partial', 'received_complete', 'completed'],
  ...
  approvalFlow: [{
    ...
    role: {
      type: String,
      required: true,
      enum: ['supervisor_mantenimiento', 'jefe_mantenimiento', 'superintendent_operaciones', 'gerente_abastecimientos', 'gerente_financiero', 'gerente_general']
    },
    userId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'User'
  ...
  warehouseInfo: {
    ...
    warehouseStatus: {
      type: String,
      enum: ['pending_assignment', 'assigned', 'in_transit', 'received_partial', 'received_complete', 'completed'],
